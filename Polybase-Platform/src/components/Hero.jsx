import { curve, database } from "../assets";
    ...
    >
      <div className="container relative" ref={parallaxRef}>
        ...
        >
          ...
          text-n-2 lg:mb-8"
          >
            A JavaScript library designed to simplify data integration and
            synchronization within polyglot environments.
          </p>
          <Button white>
            <a href="https://www.npmjs.com/package/polybase-package">Install</a>
          </Button>
        </div>
        <div
