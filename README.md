...
<b>In this version 1.0.3 launch, the package is strictly set up to set up and check database configurations. We are actively working on additional functionality to allow developers query databases and handle cross-database operations. More commands coming soon!</b>
